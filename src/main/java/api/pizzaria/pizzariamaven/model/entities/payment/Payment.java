package api.pizzaria.pizzariamaven.model.entities.payment;
...
public class Payment {
    ...
    public void escolhaDoPagamento() {
        log.info("1. Cartão de Crédito/Débito/VR.");
        log.info("2. Dinheiro");
        log.info("3. Pix");
        log.info("Digite o número do meio escolhido: ");
    ...
    public static void pagamentoEmPix() {
        ...
        log.info("7163e29e-bdaf-4f02-b492-90e161b9ede7");
